...
for shader in "$@"
do
    /opt/directx-shader-compiler/bin/dxc -T gs_6_5 -spirv -fspv-target-env=vulkan1.1 -fvk-use-gl-layout -fvk-b-shift 4 0 -fvk-b-shift 4 1 -fvk-b-shift 4 2 -Fo "../$(basename $shader .hlsl).spv"  "$shader"
done