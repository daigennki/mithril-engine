...
impl Canvas
{
		...
		-> Result<Self, GenericEngineError>
	{
		...
		let quad_pos_buf = render_ctx.new_immutable_buffer_from_iter(quad_pos_verts, vbo_usage)?;
		...
		let quad_uv_buf = render_ctx.new_immutable_buffer_from_iter(quad_uv_verts, vbo_usage)?;
